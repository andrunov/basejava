...
public class ObjectStreamFileStorageTest extends AbstractObjectStreamSerializerTest {

    @Override
    public void setUp() {
        objectStreamSerializer.setStrategy(ObjectStreamSerializer.Strategy.FILE);
