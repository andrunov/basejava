...
public class DataStreamSerializer implements StreamSerializer {
     ...
     */
    private  <T> void forEach(DataOutputStream dos, Iterable<T> collection, Container<T> container) throws IOException {
     ...
     * @throws IOException - выбрасываем для дальнейшей обработки
     */
    private <T> void forWhile(DataInputStream dis, int counter, Container<T> container, T applier) throws IOException {
